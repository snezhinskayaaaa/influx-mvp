        ...
        <div className="container px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button size="lg" asChild className="bg-gradient-to-r from-primary/15 to-secondary/15 hover:from-primary/17 hover:to-secondary/17 backdrop-blur-sm border-0 h-14 px-8 text-lg transition-all">
