        ...
        <div className="container px-6 lg:px-8 max-w-6xl mx-auto relative z-10">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-muted-foreground max-w-3xl mx-auto mb-2">
              Lock in the lowest rates on the platform — forever
            </p>
            <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
              Limited spots for early Web3 projects and creators. Once they&apos;re gone, they&apos;re gone.
            </p>
          </div>
            ...
            <Card className="p-6 sm:p-8 bg-gradient-to-br from-primary/10 via-background to-primary/5 backdrop-blur-xl border-2 border-primary/30 shadow-2xl relative">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-sm">Permanent status</p>
                    <p className="text-xs text-muted-foreground">After your first funded campaign ($100 min) within 30 days of joining</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Check className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                  <div>
                    <p className="text-xs text-muted-foreground">If not completed in 30 days, your spot goes to the next project in line</p>
                  </div>
                </div>
              </div>
          ...
          {/* Total Comparison */}
          <div className="p-6 bg-gradient-to-r from-primary/5 via-transparent to-secondary/5 rounded-2xl border border-primary/20">
