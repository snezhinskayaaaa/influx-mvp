                          ...
                          <div className="space-y-3">
                            ...
                            {(!selectedInfluencerForPipeline.contentRevisions || selectedInfluencerForPipeline.contentRevisions.length === 0) && selectedInfluencerForPipeline.contentUrl && (
                              <div className="space-y-3">
                                ...
                                ) : ["RESOLVED", "COMPLETED", "DELIVERED", "PUBLISHING", "DISPUTED"].includes(selectedInfluencerForPipeline.collaborationStatus ?? "") ? null : (<>
                                <div className="flex gap-2">
                                  <Button
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="flex items-center gap-2">
                    {campaign.status === "completed" ? (
                      <span className="inline-flex items-center w-[90px] justify-center rounded-full border px-2.5 py-0.5 text-xs font-semibold" style={{ backgroundColor: 'rgba(107,114,128,0.1)', color: '#6b7280', borderColor: 'rgba(107,114,128,0.3)' }}>
                        <span className="rounded-full mr-1.5" style={{ backgroundColor: '#9ca3af', display: 'inline-block', width: '6px', height: '6px', minWidth: '6px' }} />
                        Completed
                      </span>
                    ) : (
                    <Badge
