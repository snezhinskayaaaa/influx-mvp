...
export function OnboardingLayout({
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* Content */}
      <main className="flex-1 px-4 py-4 sm:px-6 sm:py-12">
        <div className="max-w-4xl mx-auto">
          {onBack && (
            <Button
              ...
              size="sm"
              onClick={onBack}
              className="mb-3 sm:mb-8 -ml-2 hover:bg-muted hover:text-foreground text-xs sm:text-sm"
            >
          ...
          <div className="mb-4 sm:mb-8">
            <h1 className="text-xl sm:text-3xl lg:text-4xl font-bold mb-1 sm:mb-3">
              {title}
            </h1>
            {subtitle && (
